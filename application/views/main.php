...
<html lang="id" translate="no">
	<head>
	  ...
	  <link href="<?=base_url('assets/favicon.png')?>" rel="icon" type="image/png" />	
		...
		<?php $this->load->view('js/local_storage') ?>
	</head>
	<body style="padding-top: 90px">
		...
		<?php 
		$this->load->view('footer', ['admin'=>FALSE]);
		$this->load->view('modals', ['admin'=>FALSE]);
		$this->load->view('modal_db', ['admin'=>FALSE]);
		$this->load->view('iklan', ['admin'=>FALSE]);
		?>
